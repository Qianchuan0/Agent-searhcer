...
const FeatureList = [
  {
    ...
    description: (
      <>
        agent Researcher is an open source autonomous agent designed for comprehensive online research on a variety of tasks.
      </>
    ),
  },
  /*{
  ...
  },
  {
    ...
    description: (
      <>
          Check out agent Researcher in action across multiple frameworks and use cases such as hybrid research and long detailed reports.
      </>
    ),
  },
];
