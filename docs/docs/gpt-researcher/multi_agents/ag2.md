...
This example uses AG2 to orchestrate the agent Researcher multi-agent workflow.

Check out our blog posts:
- [Deep Web Research with AG2 and agent Researcher](https://docs.ag2.ai/latest/docs/blog/#deep-web-research-with-ag2-and-gpt-researcher) (AG2 Blog)
