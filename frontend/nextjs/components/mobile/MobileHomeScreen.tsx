      ...
      <div className="pt-10 px-6 text-center mb-8">
        <div className="flex justify-center mb-3">
          <img
            ...
            alt="agent Researcher"
            width={60}
            height={60}
            className="rounded-xl"
          />
        </div>
        <p className="text-gray-400 text-sm">你好，这里是 agent Researcher。它可以帮你快速获取洞察并完成更全面的研究。</p>
      </div>
        ...
        <div className="bg-gray-800/40 border border-gray-700/50 rounded-xl p-4">
          ...
          <ul className="text-xs text-gray-400 space-y-1.5">
            <li className="flex items-start">
              ...
              <span>问题越具体，结果通常越准确。</span>
            </li>
            <li className="flex items-start">
              <span className="text-sky-400 mr-1.5">•</span>
              <span>尽量补充日期、背景和上下文信息。</span>
            </li>
            <li className="flex items-start">
              <span className="text-sky-400 mr-1.5">•</span>
              <span>研究完成后，可以继续追问以获得更深入的洞察。</span>
            </li>
          </ul>
        </div>
      </div>
