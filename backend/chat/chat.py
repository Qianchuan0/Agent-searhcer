...
# Note: LLM client is now handled through agent Researcher's unified LLM system
...
class ChatAgentWithMemory:
    ...
    async def chat(self, messages, websocket=None):
        ...
        try:
            ...
            system_prompt = f"""
            You are agent Researcher, an autonomous research agent created by an open source community, homepage: https://gptr.dev.
            To learn more about agent Researcher you can suggest to check out: https://docs.gptr.dev.
